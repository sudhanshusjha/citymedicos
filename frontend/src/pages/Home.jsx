          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href={`https://wa.me/${PHONE}?text=Hello%20City%20Medicos,%20I%20want%20to%20order%20medicines.%20Sending%20prescription.`} target="_blank" rel="noopener noreferrer" className="btn-prescription">
                  📷 Upload Prescription
                </a>
              </div>
            </div>
