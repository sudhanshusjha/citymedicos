      ...
      <section className="section-gap bg-[#FAFAFA]">
        <div className="container-main">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl font-black mb-4" style={{ fontFamily: 'Outfit' }}>Terms & Conditions</h1>
      ...
      <section className="section-gap bg-white">
        <div className="container-main">
          <div className="max-w-3xl space-y-10">
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ fontFamily: 'Outfit' }}>Acceptance of Terms</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ fontFamily: 'Outfit' }}>Services Offered</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ fontFamily: 'Outfit' }}>Prescription Requirements</h2>
              <p className="text-lg text-[#333] leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ fontFamily: 'Outfit' }}>Home Delivery Terms</h2>
              <ul className="list-disc list-inside space-y-2 text-lg text-[#333]">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ fontFamily: 'Outfit' }}>Returns and Refunds</h2>
              <ul className="list-disc list-inside space-y-2 text-lg text-[#333]">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ fontFamily: 'Outfit' }}>Disclaimer</h2>
              <p className="text-lg text-[#333] leading-relaxed">
            ...
            <div>
              ...
              <p className="text-lg text-[#333] mb-6">Questions about these terms? Contact us:</p>
